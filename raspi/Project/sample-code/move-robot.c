...
int main(int argc, char *argv[])
{
  ...
  while(1){
    ...
    if(strstr(buffer, "left") != NULL){
      ...
      gpioPWM(17, 200+left_factor/10); /* 192/255 = 75% */
      gpioPWM(22, 200+left_factor/10);
      start = time_time();
      while ((time_time() - start) < 1.0)
      {
        gpioWrite(18, 0);
        time_sleep(0.5);
	gpioWrite(27, 0); /* 192/255 = 75% */
        time_sleep(0.5);
      }
      gpioPWM(17, 0);
      gpioPWM(22, 0);
      ...
      /* Start 75% dutycycle PWM on GPIO17 */
      gpioPWM(18, 200+right_factor/10);
      gpioPWM(27, 200+right_factor/10); /* 192/255 = 75% */
      start = time_time();
      while ((time_time() - start) < 1.0)
      {
        gpioWrite(17, 0); /* 192/255 = 75% */
        time_sleep(0.5);
        gpioWrite(22, 0);
        time_sleep(0.5);
      }
    ...
    /*if(strstr(buffer, "forward") != NULL){
      ...
      string str(buffer);
      int distance = 0; 
      stringstream geek(str.substr(str.find("!")+1));
      geek >> distance;
      ...
      gpioPWM(27, 192); 
      start = time_time();
      cout << "time is :: " << 1.0+abs(distance-90)/20 << endl;
      while ((time_time() - start) < 1.0+abs(distance-90)/20)
      {
        gpioWrite(18, 0);
        time_sleep(0.5);
        gpioWrite(22, 0);
      ...
      gpioPWM(22, 202); 
      start = time_time();
      cout << "time is :: " << 1.0+abs(90-distance)/20 << endl;
      // while ((time_time() - start) < 1.0+abs(90-distance)/20)
      while ((time_time() - start) < 1.0)
      {
        gpioWrite(17, 0);
        time_sleep(0.5);
